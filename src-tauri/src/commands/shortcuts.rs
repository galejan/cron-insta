...
fn default_shortcuts() -> Vec<ShortcutBinding> {
    vec![
        ...
        // cycle-tabs removed — entity tabs now have direct Ctrl+Shift+1..5 access
        // ── Editor ───────────────────────────────────────────
        ShortcutBinding {
            id: "save".into(),
            key: "s".into(),
        ...
        // ── Project operations ───────────────────────────────
        // new-chapter shortcut removed — will be re-added later without shortcut for now
        ShortcutBinding {
        ...
        // ── Tabs ────────────────────────────────────────────
        ShortcutBinding {
            id: "tab-chapters".into(),
            key: "1".into(),
            ctrl: true,
            shift: true,
            alt: false,
            label_es: "Pestaña Capítulos".into(),
            label_en: "Chapters tab".into(),
        },
        ShortcutBinding {
            id: "tab-characters".into(),
            key: "2".into(),
            ctrl: true,
            shift: true,
            alt: false,
            label_es: "Pestaña Personajes".into(),
            label_en: "Characters tab".into(),
        },
        ShortcutBinding {
            id: "tab-notes".into(),
            key: "3".into(),
            ...
            shift: true,
            alt: false,
            label_es: "Pestaña Notas".into(),
            label_en: "Notes tab".into(),
        },
        ShortcutBinding {
            id: "tab-timeline".into(),
            key: "4".into(),
            ctrl: true,
            shift: true,
            alt: false,
            label_es: "Pestaña Línea de tiempo".into(),
            label_en: "Timeline tab".into(),
        },
        ShortcutBinding {
            id: "tab-places".into(),
            key: "5".into(),
            ...
            shift: true,
            alt: false,
            label_es: "Pestaña Lugares".into(),
            label_en: "Places tab".into(),
        },
        ShortcutBinding {
            id: "tab-media".into(),
            key: "6".into(),
            ...
            shift: true,
            alt: false,
            label_es: "Pestaña Media".into(),
            label_en: "Media tab".into(),
        },
        // ── UI toggles ───────────────────────────────────────
        ShortcutBinding {
            id: "dock".into(),
